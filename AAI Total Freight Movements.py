...
s ='''SELECT * FROM [ForOperationsData].[dbo].[IN_Monthly_Freight_Movements]'''
...
print(df3)
df3.to_excel("Total Freight Movements.xlsx", sheet_name='Ratio(Total Freight Movements)', index=True)